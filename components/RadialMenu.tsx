...
import { Palette, Layers, Grid, List, CloudRain, Sun, Zap, ArrowLeft, Search, BookOpen, LayoutTemplate, Bookmark, Sparkles } from 'lucide-react';
...
export const RadialMenu: React.FC<RadialMenuProps> = ({
    ...
    useEffect(() => {
        const handleContextMenu = (e: MouseEvent) => {
            // Only trigger if NOT on a book card (which has its own context menu)
